...
const Toaster: (props: ToasterProps) => JSX.Element = ({ ...props }: ToasterProps) => {
    return (
        <Sonner
            toastOptions={{
                classNames: {
                    toast: 'h-auto w-full p-4 bg-background border group toast group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border flex items-center relative',
