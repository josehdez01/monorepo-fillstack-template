...
const Dialog: typeof ReactDialog.Root = ReactDialog.Root;
const DialogTrigger: typeof ReactDialog.Trigger = ReactDialog.Trigger;
...
const DialogComponent: DialogComponentType = Object.assign(Dialog, {
